...
class SKYLIZED extends EventTarget {
    constructor() {
        ...
        this._repetiveTasks = {
            ...
            timings: ({ timezone, country, format = "24" }) => {
                const digitalClock_dateElements = document.querySelectorAll(".digitalClock_date");
                const digitalClock_timeElements = document.querySelectorAll(".digitalClock_time");
    ...
    init() {
        setInterval(() => { SKYLIZE._repetiveTasks.timings({ timezone: "Europe/Berlin", country: "de-DE", format: "24" }) }, 1000)
        SKYLIZE._repetiveTasks.timings({ timezone: "Europe/Berlin", country: "de-DE", format: "24" })
        SKYLIZE.repeatTasks()
